...
<body>
    ...
    if ($totalqty == 0) {
        echo "You did not order anything on the previous pages!<br />";
    } else {
        if ($tireqty > 0) {
    ...
    try {
        ...
        echo "<p><strong>Orders file cound not be opened.<br />Please contact our webmaster for help.</strong></p>";
    } catch (Exception $e) {
